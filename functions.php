...
/*
:::::::::::::     * A_SETTINGS POL-Framework includes
The $p0l_includes array determines the code library included in your theme.
...
// includini in queto file tutti i percorsi presenti nell arraydi p0l_include 
foreach ($p0l_includes as $file) {
	if (!$filepath = locate_template($file)) {
		trigger_error(sprintf(__('Error locating %s for inclusion', 'p0l'), $file), E_USER_ERROR);
	}
...
class StarterSite extends Timber\Site {
	...
	*/
	public function add_to_context( $context ) {
		...
		$context['main_container']          = get_theme_mod("p0l_setting_main_container");
		$context['p0l_setting_gototop']     = get_theme_mod("p0l_setting_gototop");
		$context['p0l_setting_butter']      = get_theme_mod("p0l_setting_butter");
		$context['p0l_setting_magic_mouse'] = get_theme_mod("p0l_setting_magic_mouse");
		...
		*/
		...
		/*    $p0l_setting_google_fonts = get_theme_mod("p0l_setting_google_fonts");
		$google_fonts = explode("\n", $p0l_setting_google_fonts);
		...
		$p0l_setting_google_fonts
		$context['p0l_setting_google_fonts'] =
		*/
		
		  // * A_SETTINGS Setting
		$context['setting_intestazione'] = get_theme_mod('p0l_setting_intestazione');
		$context['setting_piva']         = get_theme_mod('p0l_setting_piva');
		$context['setting_rea']          = get_theme_mod('p0l_setting_rea');
		$context['setting_cap_soc']      = get_theme_mod('p0l_setting_cap_soc');
		  // indirizzo
		$context['setting_indirizzo_1'] = get_theme_mod('p0l_setting_indirizzo_1');
		$context['setting_indirizzo_2'] = get_theme_mod('p0l_setting_indirizzo_2');
		$context['setting_indirizzo_3'] = get_theme_mod('p0l_setting_indirizzo_3');
		  // tel
		$context['setting_tel_1'] = get_theme_mod('p0l_setting_tel_1');
		$context['setting_tel_2'] = get_theme_mod('p0l_setting_tel_2');
		$context['setting_tel_3'] = get_theme_mod('p0l_setting_tel_3');
		$context['setting_fax']   = get_theme_mod('p0l_setting_fax');
		  // mail
		$context['setting_mail_1'] = get_theme_mod('p0l_setting_mail_1');
		$context['setting_mail_2'] = get_theme_mod('p0l_setting_mail_2');
		$context['setting_mail_3'] = get_theme_mod('p0l_setting_mail_3');
		  // social
		$context['setting_facebook']  = get_theme_mod('p0l_setting_facebook');
		$context['setting_linkedin']  = get_theme_mod('p0l_setting_linkedin');
		$context['setting_instagram'] = get_theme_mod('p0l_setting_instagram');
		$context['setting_behance']   = get_theme_mod('p0l_setting_behance');
		$context['setting_vi']        = get_theme_mod('p0l_setting_vi');
		...
		$gmaps_api_key = get_theme_mod('p0l_setting_maps');
...
function my_acf_google_map_api($api) {
    $api['key'] = get_theme_mod('p0l_setting_maps');
    return $api;
}
...
function my_acf_init() {
    acf_update_setting('google_api_key', get_theme_mod('p0l_setting_maps'));
}
...
function poliedro_tema_personalizzato_admin_color_scheme() {
	//Get the theme directory
	$theme_dir = get_stylesheet_directory_uri();

	//Poliedro tema personalizzato
	wp_admin_css_color( 'poliedro_tema_personalizzato', __( 'Poliedro tema personalizzato' ),
		$theme_dir . '/poliedro_tema_personalizzato.css',
		array( '#444444', '#ffffff', '#fcaf18' , '#02b0b5')
	);
}
add_action('admin_init', 'poliedro_tema_personalizzato_admin_color_scheme');
