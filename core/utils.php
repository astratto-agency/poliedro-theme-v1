...
if (!function_exists('p0l_body_class')) {
  function p0l_get_search_form() {
    $form = '';
    if (get_theme_mod('p0l_adv_twig')) {
  ...
  add_filter('get_search_form', 'p0l_get_search_form');
}
 ...
 */
if (!function_exists('p0l_body_class')) {
  function p0l_body_class($classes) {
    // Add post/page slug
  ...
  add_filter('body_class', 'p0l_body_class');
}


// send html formatted email only
if (!function_exists('p0l_set_content_type')) {
  function p0l_set_content_type(){
      return "text/html";
  }
  add_filter( 'wp_mail_content_type','p0l_set_content_type' );
}
