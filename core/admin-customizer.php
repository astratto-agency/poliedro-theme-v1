...
function linked_url()
{
    add_menu_page('linked_url', 'POLIEDRO', 'read', 'poliedro_site', '', 'dashicons-format-chat', 1);
}
...
{
    global $menu;
    $menu[1][2] = "https://www.poliedrostudio.it/";
}

function login_background_image()
{
    echo '<style type="text/css">
        body.login{ background: #585852!important; }
        .login #backtoblog a, 
...
{ ?>
    <style type="text/css">
        #login h1 a, .login h1 a {
            background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/icon-poliedro.png);
...
{
    return 'https://www.poliedrostudio.it/';
}
