...
function p0l_scripts()
{
    ...
    if (!is_admin() && current_theme_supports('jquery-cdn')) {
        ...
        add_filter('script_loader_src', 'p0l_jquery_local_fallback', 10, 2);
    }
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_BOOTSTRAP']) {
        wp_enqueue_style('bootstrap', get_template_directory_uri() . '/assets/bootstrap-4.6.2-dist/css/bootstrap.min.css');
        wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/bootstrap-4.6.2-dist/js/bootstrap.bundle.js', array(), '4.6.2', true);
    }
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_FA']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_ANIMATE']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_HOVER']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_GSAP']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_THREE']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_FITTY']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_IMAGESLOADED']) {
        wp_enqueue_script('imagesloaded_p0l', get_template_directory_uri() . '/assets/imagesloaded/imagesloaded.pkgd.min.js', array(), '1.0.0', true);
    }
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_MASONRY']) {
        wp_enqueue_script('masonry_p0l', get_template_directory_uri() . '/assets/masonry/masonry.js', array(), '1.0.0', true);
    }
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_SWIPER']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_OWL_CAROUSEL']) {
   ...
   if ($GLOBALS['assets_options']['p0l_SETTING_JARALLAX']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_NPROGRESS']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_MAGIC_MOUSE']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_BUTTER']) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_COCOEN']) {
    ...
    foreach ($GLOBALS['p0l_SETTING_CSS'] as $nome => $percorso) {
    ...
    foreach ($GLOBALS['p0l_SETTING_JS'] as $nome => $percorso) {
    ...
    if ($GLOBALS['assets_options']['p0l_SETTING_COOKIES']) {
        wp_enqueue_script('cookies', get_template_directory_uri() . '/assets/cookiechoices.js', array(), '1.0.0', true);
    }

}

add_action('wp_enqueue_scripts', 'p0l_scripts', 100);


function p0l_scripts_custom()
{
    /*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
add_action('wp_enqueue_scripts', 'p0l_scripts_custom', 110);
...
function p0l_jquery_local_fallback($src, $handle = null)
{
...
add_action('wp_head', 'p0l_jquery_local_fallback');
...
function p0l_cookies()
{ ?>
    <script>
        document.addEventListener('DOMContentLoaded', function (event) {
            cookieChoices.showCookieConsentBar('<?php echo get_theme_mod("p0l_setting_pri_msg"); ?>', '<?php echo get_theme_mod("p0l_setting_pri_close"); ?>', '<?php echo get_theme_mod("p0l_setting_pri_title"); ?>', '<?php echo get_post_permalink(get_theme_mod("p0l_setting_pri_url")); ?>');
        });
    </script>
<?php }
...
if ($GLOBALS['assets_options']['p0l_SETTING_COOKIES']) {
    add_action('wp_footer', 'p0l_cookies', 20);
}
...
if (get_theme_mod('p0l_setting_analytics') != '') {
    function p0l_google_analytics()
    { ?>
        <!-- Google Analytics -->
        <script>
            ...
            ga('create', '<?php echo get_theme_mod('p0l_setting_analytics'); ?>', 'auto');
            ga('send', 'pageview');
        </script>
        <!-- End Google Analytics -->
        <!-- Global Site Tag (gtag.js) - Google Analytics -->
        <script async
                src="https://www.googletagmanager.com/gtag/js?id=<?php echo get_theme_mod('p0l_setting_analytics'); ?>"></script>
        <script>
            ...
            gtag('config', '<?php echo get_theme_mod('p0l_setting_analytics'); ?>');
        </script>
    <?php }

    add_action('wp_head', 'p0l_google_analytics', 20);
}

/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::::::::::::::    * A_SETTINGS Google Tag Manager
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
if (get_theme_mod('p0l_setting_gtag') != '') {


    function p0l_gtag_head_analytics()
    { ?>
        <!-- Google Tag Manager -->
        <script>(function (w, d, s, l, i) {
            ...
            })(window, document, 'script', 'dataLayer', '<?php echo get_theme_mod('p0l_setting_gtag'); ?>');
        </script>
        <!-- End Google Tag Manager -->
        <?php
    }

    add_action('wp_head', 'p0l_gtag_head_analytics', 20);


    function p0l_gtag_body_analytics()
    { ?>
        <!-- Google Tag Manager (noscript) -->
        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=<?php echo get_theme_mod('p0l_setting_gtag'); ?>"
    ...
    add_action('after_body', 'p0l_gtag_body_analytics', 20);
}
...
if (get_theme_mod('p0l_setting_hotjar') != '') {
    function p0l_hotjar_analytics()
    { ?>
        ...
        <script>
            ...
            (function (h, o, t, j, a, r) {
                ...
                h._hjSettings = {hjid:<?php echo get_theme_mod('p0l_setting_hotjar'); ?>, hjsv: 5};
    ...
    add_action('wp_footer', 'p0l_hotjar_analytics', 20);
}
...
add_action('wp_footer', 'p0l_theme_version', 22);
